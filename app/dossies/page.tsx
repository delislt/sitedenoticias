...
export const metadata: Metadata = {
  ...
  description: 'Materiais de preparação dos comitês Jurídico, CSNU e Histórico do SIS.',
};

export default function DossiersPage() {
  return (
    <div className="container-premium py-10 sm:py-14">
      <section className="dossier-panel relative overflow-hidden p-6 sm:p-8 lg:p-10" aria-labelledby="dossiers-title">
        ...
        <div className="relative flex flex-col justify-between gap-4 lg:flex-row lg:items-end">
          <div className="space-y-3">
            ...
            <h1 id="dossiers-title" className="font-display text-4xl text-zinc-100 sm:text-5xl">Dossiês dos comitês</h1>
